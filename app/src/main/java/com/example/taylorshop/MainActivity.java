...
//
//        customerVM = new ViewModelProvider(this).get(CustomerVM.class);
...
//            });
//        } else {
//            customerVM.getCustomerList().observe(this,user -> {
//
//                for (int i = 0; i < user.size(); i++) {
//                    Customer customer = user.get(i);
//                    customer.setKey(.getKey());
//                    customer.getName();
//                    customer.getSerial_number();
//                    customer.getPhone_number();
//                    arrayList.add(customer);
